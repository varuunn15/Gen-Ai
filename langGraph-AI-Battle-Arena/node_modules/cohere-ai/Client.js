...
const Client_1 = require("./api/resources/audio/client/Client");
const Client_2 = require("./api/resources/batches/client/Client");
const Client_3 = require("./api/resources/connectors/client/Client");
const Client_4 = require("./api/resources/datasets/client/Client");
const Client_5 = require("./api/resources/embedJobs/client/Client");
...
class CohereClient {
    ...
    get v2() {
        var _a;
        return ((_a = this._v2) !== null && _a !== void 0 ? _a : (this._v2 = new Client_8.V2Client(this._options)));
    }
    get batches() {
        var _a;
        return ((_a = this._batches) !== null && _a !== void 0 ? _a : (this._batches = new Client_2.BatchesClient(this._options)));
    }
    get embedJobs() {
        var _a;
        return ((_a = this._embedJobs) !== null && _a !== void 0 ? _a : (this._embedJobs = new Client_5.EmbedJobsClient(this._options)));
    }
    get datasets() {
        var _a;
        return ((_a = this._datasets) !== null && _a !== void 0 ? _a : (this._datasets = new Client_4.DatasetsClient(this._options)));
    }
    get connectors() {
        var _a;
        return ((_a = this._connectors) !== null && _a !== void 0 ? _a : (this._connectors = new Client_3.ConnectorsClient(this._options)));
    }
    get models() {
        var _a;
    ...
    get finetuning() {
        var _a;
        return ((_a = this._finetuning) !== null && _a !== void 0 ? _a : (this._finetuning = new Client_6.FinetuningClient(this._options)));
    }
    get audio() {
        var _a;
    ...
    __chatStream(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/v1/chat");
        });
    }
    /**
    ...
    __generateStream(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/v1/generate");
        });
    }
    /**
     * @deprecated
    ...
    __embed() {
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            ...
            return (0, handleNonStatusCodeError_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/v1/embed");
        });
    }
    /**
    ...
    __rerank(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/v1/rerank");
        });
    }
    /**
     * @deprecated
    ...
    __classify(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/v1/classify");
        });
    }
    /**
     * @deprecated
    ...
    __summarize(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/v1/summarize");
        });
    }
    /**
    ...
    __tokenize(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/v1/tokenize");
        });
    }
    /**
    ...
    __detokenize(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/v1/detokenize");
        });
    }
    /**
    ...
    __checkApiKey(requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/v1/check-api-key");
        });
    }
    /**
