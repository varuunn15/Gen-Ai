...
declare const CreateHubContentPresignedUrlsCommand_base: {
    new (input: CreateHubContentPresignedUrlsCommandInput): import("@smithy/core/client").CommandImpl<CreateHubContentPresignedUrlsCommandInput, CreateHubContentPresignedUrlsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateHubContentPresignedUrlsCommandInput): import("@smithy/core/client").CommandImpl<CreateHubContentPresignedUrlsCommandInput, CreateHubContentPresignedUrlsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
