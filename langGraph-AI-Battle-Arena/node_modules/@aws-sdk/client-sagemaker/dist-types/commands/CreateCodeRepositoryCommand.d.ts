...
declare const CreateCodeRepositoryCommand_base: {
    new (input: CreateCodeRepositoryCommandInput): import("@smithy/core/client").CommandImpl<CreateCodeRepositoryCommandInput, CreateCodeRepositoryCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateCodeRepositoryCommandInput): import("@smithy/core/client").CommandImpl<CreateCodeRepositoryCommandInput, CreateCodeRepositoryCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
