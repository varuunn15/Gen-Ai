...
declare const ListInferenceExperimentsCommand_base: {
    new (input: ListInferenceExperimentsCommandInput): import("@smithy/core/client").CommandImpl<ListInferenceExperimentsCommandInput, ListInferenceExperimentsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListInferenceExperimentsCommandInput]): import("@smithy/core/client").CommandImpl<ListInferenceExperimentsCommandInput, ListInferenceExperimentsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
