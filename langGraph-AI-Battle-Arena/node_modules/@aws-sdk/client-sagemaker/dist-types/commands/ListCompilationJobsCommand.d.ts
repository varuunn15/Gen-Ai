...
declare const ListCompilationJobsCommand_base: {
    new (input: ListCompilationJobsCommandInput): import("@smithy/core/client").CommandImpl<ListCompilationJobsCommandInput, ListCompilationJobsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListCompilationJobsCommandInput]): import("@smithy/core/client").CommandImpl<ListCompilationJobsCommandInput, ListCompilationJobsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
