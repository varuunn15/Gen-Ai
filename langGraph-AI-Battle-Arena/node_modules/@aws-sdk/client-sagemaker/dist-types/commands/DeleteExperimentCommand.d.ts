...
declare const DeleteExperimentCommand_base: {
    new (input: DeleteExperimentCommandInput): import("@smithy/core/client").CommandImpl<DeleteExperimentCommandInput, DeleteExperimentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteExperimentCommandInput): import("@smithy/core/client").CommandImpl<DeleteExperimentCommandInput, DeleteExperimentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
