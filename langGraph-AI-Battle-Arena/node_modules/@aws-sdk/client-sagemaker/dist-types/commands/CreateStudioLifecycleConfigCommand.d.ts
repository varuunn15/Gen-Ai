...
declare const CreateStudioLifecycleConfigCommand_base: {
    new (input: CreateStudioLifecycleConfigCommandInput): import("@smithy/core/client").CommandImpl<CreateStudioLifecycleConfigCommandInput, CreateStudioLifecycleConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateStudioLifecycleConfigCommandInput): import("@smithy/core/client").CommandImpl<CreateStudioLifecycleConfigCommandInput, CreateStudioLifecycleConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
