...
declare const DeleteEndpointConfigCommand_base: {
    new (input: DeleteEndpointConfigCommandInput): import("@smithy/core/client").CommandImpl<DeleteEndpointConfigCommandInput, DeleteEndpointConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteEndpointConfigCommandInput): import("@smithy/core/client").CommandImpl<DeleteEndpointConfigCommandInput, DeleteEndpointConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
