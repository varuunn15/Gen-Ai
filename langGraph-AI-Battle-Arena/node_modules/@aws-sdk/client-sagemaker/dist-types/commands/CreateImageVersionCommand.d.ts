...
declare const CreateImageVersionCommand_base: {
    new (input: CreateImageVersionCommandInput): import("@smithy/core/client").CommandImpl<CreateImageVersionCommandInput, CreateImageVersionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateImageVersionCommandInput): import("@smithy/core/client").CommandImpl<CreateImageVersionCommandInput, CreateImageVersionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
