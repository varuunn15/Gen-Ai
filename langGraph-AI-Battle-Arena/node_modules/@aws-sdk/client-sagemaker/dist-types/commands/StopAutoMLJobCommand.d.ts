...
declare const StopAutoMLJobCommand_base: {
    new (input: StopAutoMLJobCommandInput): import("@smithy/core/client").CommandImpl<StopAutoMLJobCommandInput, StopAutoMLJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopAutoMLJobCommandInput): import("@smithy/core/client").CommandImpl<StopAutoMLJobCommandInput, StopAutoMLJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
