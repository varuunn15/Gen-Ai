...
declare const DeleteHubCommand_base: {
    new (input: DeleteHubCommandInput): import("@smithy/core/client").CommandImpl<DeleteHubCommandInput, DeleteHubCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteHubCommandInput): import("@smithy/core/client").CommandImpl<DeleteHubCommandInput, DeleteHubCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
