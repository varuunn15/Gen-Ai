...
declare const StartPipelineExecutionCommand_base: {
    new (input: StartPipelineExecutionCommandInput): import("@smithy/core/client").CommandImpl<StartPipelineExecutionCommandInput, StartPipelineExecutionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartPipelineExecutionCommandInput): import("@smithy/core/client").CommandImpl<StartPipelineExecutionCommandInput, StartPipelineExecutionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
