...
declare const DisableSagemakerServicecatalogPortfolioCommand_base: {
    new (input: DisableSagemakerServicecatalogPortfolioCommandInput): import("@smithy/core/client").CommandImpl<DisableSagemakerServicecatalogPortfolioCommandInput, DisableSagemakerServicecatalogPortfolioCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DisableSagemakerServicecatalogPortfolioCommandInput]): import("@smithy/core/client").CommandImpl<DisableSagemakerServicecatalogPortfolioCommandInput, DisableSagemakerServicecatalogPortfolioCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
