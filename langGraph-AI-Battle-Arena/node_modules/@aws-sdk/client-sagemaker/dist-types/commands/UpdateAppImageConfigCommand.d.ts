...
declare const UpdateAppImageConfigCommand_base: {
    new (input: UpdateAppImageConfigCommandInput): import("@smithy/core/client").CommandImpl<UpdateAppImageConfigCommandInput, UpdateAppImageConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateAppImageConfigCommandInput): import("@smithy/core/client").CommandImpl<UpdateAppImageConfigCommandInput, UpdateAppImageConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
