...
declare const CreateDeviceFleetCommand_base: {
    new (input: CreateDeviceFleetCommandInput): import("@smithy/core/client").CommandImpl<CreateDeviceFleetCommandInput, CreateDeviceFleetCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateDeviceFleetCommandInput): import("@smithy/core/client").CommandImpl<CreateDeviceFleetCommandInput, CreateDeviceFleetCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
