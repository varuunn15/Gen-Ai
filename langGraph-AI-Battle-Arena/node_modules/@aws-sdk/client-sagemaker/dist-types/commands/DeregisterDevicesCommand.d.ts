...
declare const DeregisterDevicesCommand_base: {
    new (input: DeregisterDevicesCommandInput): import("@smithy/core/client").CommandImpl<DeregisterDevicesCommandInput, DeregisterDevicesCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeregisterDevicesCommandInput): import("@smithy/core/client").CommandImpl<DeregisterDevicesCommandInput, DeregisterDevicesCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
