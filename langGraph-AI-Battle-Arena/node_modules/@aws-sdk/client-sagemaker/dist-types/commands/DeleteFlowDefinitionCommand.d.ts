...
declare const DeleteFlowDefinitionCommand_base: {
    new (input: DeleteFlowDefinitionCommandInput): import("@smithy/core/client").CommandImpl<DeleteFlowDefinitionCommandInput, DeleteFlowDefinitionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteFlowDefinitionCommandInput): import("@smithy/core/client").CommandImpl<DeleteFlowDefinitionCommandInput, DeleteFlowDefinitionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
