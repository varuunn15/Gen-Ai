...
declare const PutModelPackageGroupPolicyCommand_base: {
    new (input: PutModelPackageGroupPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutModelPackageGroupPolicyCommandInput, PutModelPackageGroupPolicyCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutModelPackageGroupPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutModelPackageGroupPolicyCommandInput, PutModelPackageGroupPolicyCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
