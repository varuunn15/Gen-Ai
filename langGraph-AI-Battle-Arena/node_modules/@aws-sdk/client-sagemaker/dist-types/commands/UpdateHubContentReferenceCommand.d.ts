...
declare const UpdateHubContentReferenceCommand_base: {
    new (input: UpdateHubContentReferenceCommandInput): import("@smithy/core/client").CommandImpl<UpdateHubContentReferenceCommandInput, UpdateHubContentReferenceCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateHubContentReferenceCommandInput): import("@smithy/core/client").CommandImpl<UpdateHubContentReferenceCommandInput, UpdateHubContentReferenceCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
