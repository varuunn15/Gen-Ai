...
declare const ListWorkteamsCommand_base: {
    new (input: ListWorkteamsCommandInput): import("@smithy/core/client").CommandImpl<ListWorkteamsCommandInput, ListWorkteamsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListWorkteamsCommandInput]): import("@smithy/core/client").CommandImpl<ListWorkteamsCommandInput, ListWorkteamsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
