...
declare const CreateModelCardExportJobCommand_base: {
    new (input: CreateModelCardExportJobCommandInput): import("@smithy/core/client").CommandImpl<CreateModelCardExportJobCommandInput, CreateModelCardExportJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateModelCardExportJobCommandInput): import("@smithy/core/client").CommandImpl<CreateModelCardExportJobCommandInput, CreateModelCardExportJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
