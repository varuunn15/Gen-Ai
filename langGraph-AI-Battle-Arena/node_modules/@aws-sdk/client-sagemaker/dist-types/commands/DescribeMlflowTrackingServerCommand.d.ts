...
declare const DescribeMlflowTrackingServerCommand_base: {
    new (input: DescribeMlflowTrackingServerCommandInput): import("@smithy/core/client").CommandImpl<DescribeMlflowTrackingServerCommandInput, DescribeMlflowTrackingServerCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeMlflowTrackingServerCommandInput): import("@smithy/core/client").CommandImpl<DescribeMlflowTrackingServerCommandInput, DescribeMlflowTrackingServerCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
