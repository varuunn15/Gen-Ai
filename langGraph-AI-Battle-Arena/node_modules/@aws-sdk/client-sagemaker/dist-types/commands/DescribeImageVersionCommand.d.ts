...
declare const DescribeImageVersionCommand_base: {
    new (input: DescribeImageVersionCommandInput): import("@smithy/core/client").CommandImpl<DescribeImageVersionCommandInput, DescribeImageVersionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeImageVersionCommandInput): import("@smithy/core/client").CommandImpl<DescribeImageVersionCommandInput, DescribeImageVersionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
