...
declare const ListClusterSchedulerConfigsCommand_base: {
    new (input: ListClusterSchedulerConfigsCommandInput): import("@smithy/core/client").CommandImpl<ListClusterSchedulerConfigsCommandInput, ListClusterSchedulerConfigsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListClusterSchedulerConfigsCommandInput]): import("@smithy/core/client").CommandImpl<ListClusterSchedulerConfigsCommandInput, ListClusterSchedulerConfigsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
