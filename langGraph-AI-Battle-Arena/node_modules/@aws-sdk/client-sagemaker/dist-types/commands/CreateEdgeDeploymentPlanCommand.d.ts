...
declare const CreateEdgeDeploymentPlanCommand_base: {
    new (input: CreateEdgeDeploymentPlanCommandInput): import("@smithy/core/client").CommandImpl<CreateEdgeDeploymentPlanCommandInput, CreateEdgeDeploymentPlanCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateEdgeDeploymentPlanCommandInput): import("@smithy/core/client").CommandImpl<CreateEdgeDeploymentPlanCommandInput, CreateEdgeDeploymentPlanCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
