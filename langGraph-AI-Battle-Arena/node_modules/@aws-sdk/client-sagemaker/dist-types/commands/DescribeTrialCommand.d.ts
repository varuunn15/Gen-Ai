...
declare const DescribeTrialCommand_base: {
    new (input: DescribeTrialCommandInput): import("@smithy/core/client").CommandImpl<DescribeTrialCommandInput, DescribeTrialCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeTrialCommandInput): import("@smithy/core/client").CommandImpl<DescribeTrialCommandInput, DescribeTrialCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
