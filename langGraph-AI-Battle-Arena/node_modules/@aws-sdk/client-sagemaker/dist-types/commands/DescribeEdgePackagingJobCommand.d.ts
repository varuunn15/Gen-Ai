...
declare const DescribeEdgePackagingJobCommand_base: {
    new (input: DescribeEdgePackagingJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeEdgePackagingJobCommandInput, DescribeEdgePackagingJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeEdgePackagingJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeEdgePackagingJobCommandInput, DescribeEdgePackagingJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
