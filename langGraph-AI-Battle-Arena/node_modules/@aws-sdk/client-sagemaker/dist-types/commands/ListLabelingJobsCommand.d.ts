...
declare const ListLabelingJobsCommand_base: {
    new (input: ListLabelingJobsCommandInput): import("@smithy/core/client").CommandImpl<ListLabelingJobsCommandInput, ListLabelingJobsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListLabelingJobsCommandInput]): import("@smithy/core/client").CommandImpl<ListLabelingJobsCommandInput, ListLabelingJobsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
