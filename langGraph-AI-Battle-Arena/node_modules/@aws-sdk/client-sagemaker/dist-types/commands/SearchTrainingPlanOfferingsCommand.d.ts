...
declare const SearchTrainingPlanOfferingsCommand_base: {
    new (input: SearchTrainingPlanOfferingsCommandInput): import("@smithy/core/client").CommandImpl<SearchTrainingPlanOfferingsCommandInput, SearchTrainingPlanOfferingsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [SearchTrainingPlanOfferingsCommandInput]): import("@smithy/core/client").CommandImpl<SearchTrainingPlanOfferingsCommandInput, SearchTrainingPlanOfferingsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
