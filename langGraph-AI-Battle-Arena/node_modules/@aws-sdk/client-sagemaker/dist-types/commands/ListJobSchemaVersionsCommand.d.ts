...
declare const ListJobSchemaVersionsCommand_base: {
    new (input: ListJobSchemaVersionsCommandInput): import("@smithy/core/client").CommandImpl<ListJobSchemaVersionsCommandInput, ListJobSchemaVersionsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListJobSchemaVersionsCommandInput): import("@smithy/core/client").CommandImpl<ListJobSchemaVersionsCommandInput, ListJobSchemaVersionsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
