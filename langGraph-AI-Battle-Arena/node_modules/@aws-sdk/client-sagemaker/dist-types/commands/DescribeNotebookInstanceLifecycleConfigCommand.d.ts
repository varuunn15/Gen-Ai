...
declare const DescribeNotebookInstanceLifecycleConfigCommand_base: {
    new (input: DescribeNotebookInstanceLifecycleConfigCommandInput): import("@smithy/core/client").CommandImpl<DescribeNotebookInstanceLifecycleConfigCommandInput, DescribeNotebookInstanceLifecycleConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeNotebookInstanceLifecycleConfigCommandInput): import("@smithy/core/client").CommandImpl<DescribeNotebookInstanceLifecycleConfigCommandInput, DescribeNotebookInstanceLifecycleConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
