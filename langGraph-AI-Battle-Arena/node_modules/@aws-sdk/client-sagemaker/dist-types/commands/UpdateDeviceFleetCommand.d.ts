...
declare const UpdateDeviceFleetCommand_base: {
    new (input: UpdateDeviceFleetCommandInput): import("@smithy/core/client").CommandImpl<UpdateDeviceFleetCommandInput, UpdateDeviceFleetCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateDeviceFleetCommandInput): import("@smithy/core/client").CommandImpl<UpdateDeviceFleetCommandInput, UpdateDeviceFleetCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
