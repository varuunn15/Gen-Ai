...
declare const DeleteClusterSchedulerConfigCommand_base: {
    new (input: DeleteClusterSchedulerConfigCommandInput): import("@smithy/core/client").CommandImpl<DeleteClusterSchedulerConfigCommandInput, DeleteClusterSchedulerConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteClusterSchedulerConfigCommandInput): import("@smithy/core/client").CommandImpl<DeleteClusterSchedulerConfigCommandInput, DeleteClusterSchedulerConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
