...
declare const StartMonitoringScheduleCommand_base: {
    new (input: StartMonitoringScheduleCommandInput): import("@smithy/core/client").CommandImpl<StartMonitoringScheduleCommandInput, StartMonitoringScheduleCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartMonitoringScheduleCommandInput): import("@smithy/core/client").CommandImpl<StartMonitoringScheduleCommandInput, StartMonitoringScheduleCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
