...
declare const UpdateImageCommand_base: {
    new (input: UpdateImageCommandInput): import("@smithy/core/client").CommandImpl<UpdateImageCommandInput, UpdateImageCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateImageCommandInput): import("@smithy/core/client").CommandImpl<UpdateImageCommandInput, UpdateImageCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
