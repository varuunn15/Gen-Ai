...
declare const DeleteImageCommand_base: {
    new (input: DeleteImageCommandInput): import("@smithy/core/client").CommandImpl<DeleteImageCommandInput, DeleteImageCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteImageCommandInput): import("@smithy/core/client").CommandImpl<DeleteImageCommandInput, DeleteImageCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
