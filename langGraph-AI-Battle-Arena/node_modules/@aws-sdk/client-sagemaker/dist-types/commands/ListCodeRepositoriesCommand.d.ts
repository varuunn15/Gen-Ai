...
declare const ListCodeRepositoriesCommand_base: {
    new (input: ListCodeRepositoriesCommandInput): import("@smithy/core/client").CommandImpl<ListCodeRepositoriesCommandInput, ListCodeRepositoriesCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListCodeRepositoriesCommandInput]): import("@smithy/core/client").CommandImpl<ListCodeRepositoriesCommandInput, ListCodeRepositoriesCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
