...
declare const GetSearchSuggestionsCommand_base: {
    new (input: GetSearchSuggestionsCommandInput): import("@smithy/core/client").CommandImpl<GetSearchSuggestionsCommandInput, GetSearchSuggestionsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetSearchSuggestionsCommandInput): import("@smithy/core/client").CommandImpl<GetSearchSuggestionsCommandInput, GetSearchSuggestionsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
