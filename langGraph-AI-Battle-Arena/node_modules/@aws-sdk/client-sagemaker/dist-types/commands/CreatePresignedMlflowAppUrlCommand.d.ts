...
declare const CreatePresignedMlflowAppUrlCommand_base: {
    new (input: CreatePresignedMlflowAppUrlCommandInput): import("@smithy/core/client").CommandImpl<CreatePresignedMlflowAppUrlCommandInput, CreatePresignedMlflowAppUrlCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreatePresignedMlflowAppUrlCommandInput): import("@smithy/core/client").CommandImpl<CreatePresignedMlflowAppUrlCommandInput, CreatePresignedMlflowAppUrlCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
