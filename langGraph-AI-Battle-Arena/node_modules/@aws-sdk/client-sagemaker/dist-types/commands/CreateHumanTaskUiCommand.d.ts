...
declare const CreateHumanTaskUiCommand_base: {
    new (input: CreateHumanTaskUiCommandInput): import("@smithy/core/client").CommandImpl<CreateHumanTaskUiCommandInput, CreateHumanTaskUiCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateHumanTaskUiCommandInput): import("@smithy/core/client").CommandImpl<CreateHumanTaskUiCommandInput, CreateHumanTaskUiCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
