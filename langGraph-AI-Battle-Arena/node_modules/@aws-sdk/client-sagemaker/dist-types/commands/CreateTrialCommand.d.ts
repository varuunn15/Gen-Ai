...
declare const CreateTrialCommand_base: {
    new (input: CreateTrialCommandInput): import("@smithy/core/client").CommandImpl<CreateTrialCommandInput, CreateTrialCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTrialCommandInput): import("@smithy/core/client").CommandImpl<CreateTrialCommandInput, CreateTrialCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
