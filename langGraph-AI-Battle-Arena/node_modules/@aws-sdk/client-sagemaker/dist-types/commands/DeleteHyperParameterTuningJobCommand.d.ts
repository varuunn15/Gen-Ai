...
declare const DeleteHyperParameterTuningJobCommand_base: {
    new (input: DeleteHyperParameterTuningJobCommandInput): import("@smithy/core/client").CommandImpl<DeleteHyperParameterTuningJobCommandInput, DeleteHyperParameterTuningJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteHyperParameterTuningJobCommandInput): import("@smithy/core/client").CommandImpl<DeleteHyperParameterTuningJobCommandInput, DeleteHyperParameterTuningJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
