...
declare const ExtendTrainingPlanCommand_base: {
    new (input: ExtendTrainingPlanCommandInput): import("@smithy/core/client").CommandImpl<ExtendTrainingPlanCommandInput, ExtendTrainingPlanCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ExtendTrainingPlanCommandInput): import("@smithy/core/client").CommandImpl<ExtendTrainingPlanCommandInput, ExtendTrainingPlanCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
