...
declare const RenderUiTemplateCommand_base: {
    new (input: RenderUiTemplateCommandInput): import("@smithy/core/client").CommandImpl<RenderUiTemplateCommandInput, RenderUiTemplateCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RenderUiTemplateCommandInput): import("@smithy/core/client").CommandImpl<RenderUiTemplateCommandInput, RenderUiTemplateCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
