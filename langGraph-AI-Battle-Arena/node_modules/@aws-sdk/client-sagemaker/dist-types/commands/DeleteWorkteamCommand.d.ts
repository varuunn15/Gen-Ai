...
declare const DeleteWorkteamCommand_base: {
    new (input: DeleteWorkteamCommandInput): import("@smithy/core/client").CommandImpl<DeleteWorkteamCommandInput, DeleteWorkteamCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteWorkteamCommandInput): import("@smithy/core/client").CommandImpl<DeleteWorkteamCommandInput, DeleteWorkteamCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
