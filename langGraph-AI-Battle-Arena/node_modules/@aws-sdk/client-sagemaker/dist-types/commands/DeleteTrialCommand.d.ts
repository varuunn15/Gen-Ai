...
declare const DeleteTrialCommand_base: {
    new (input: DeleteTrialCommandInput): import("@smithy/core/client").CommandImpl<DeleteTrialCommandInput, DeleteTrialCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteTrialCommandInput): import("@smithy/core/client").CommandImpl<DeleteTrialCommandInput, DeleteTrialCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
