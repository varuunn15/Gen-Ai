...
declare const DescribeProjectCommand_base: {
    new (input: DescribeProjectCommandInput): import("@smithy/core/client").CommandImpl<DescribeProjectCommandInput, DescribeProjectCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeProjectCommandInput): import("@smithy/core/client").CommandImpl<DescribeProjectCommandInput, DescribeProjectCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
