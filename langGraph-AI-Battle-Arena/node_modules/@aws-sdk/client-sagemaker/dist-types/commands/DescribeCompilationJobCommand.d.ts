...
declare const DescribeCompilationJobCommand_base: {
    new (input: DescribeCompilationJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeCompilationJobCommandInput, DescribeCompilationJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeCompilationJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeCompilationJobCommandInput, DescribeCompilationJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
