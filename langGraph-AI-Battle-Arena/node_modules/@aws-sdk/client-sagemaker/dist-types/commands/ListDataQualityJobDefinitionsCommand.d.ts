...
declare const ListDataQualityJobDefinitionsCommand_base: {
    new (input: ListDataQualityJobDefinitionsCommandInput): import("@smithy/core/client").CommandImpl<ListDataQualityJobDefinitionsCommandInput, ListDataQualityJobDefinitionsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListDataQualityJobDefinitionsCommandInput]): import("@smithy/core/client").CommandImpl<ListDataQualityJobDefinitionsCommandInput, ListDataQualityJobDefinitionsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
