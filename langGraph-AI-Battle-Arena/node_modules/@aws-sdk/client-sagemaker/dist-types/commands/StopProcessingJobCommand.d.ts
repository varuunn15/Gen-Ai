...
declare const StopProcessingJobCommand_base: {
    new (input: StopProcessingJobCommandInput): import("@smithy/core/client").CommandImpl<StopProcessingJobCommandInput, StopProcessingJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopProcessingJobCommandInput): import("@smithy/core/client").CommandImpl<StopProcessingJobCommandInput, StopProcessingJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
