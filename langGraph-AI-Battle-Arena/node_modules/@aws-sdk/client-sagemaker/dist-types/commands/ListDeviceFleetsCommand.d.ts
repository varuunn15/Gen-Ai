...
declare const ListDeviceFleetsCommand_base: {
    new (input: ListDeviceFleetsCommandInput): import("@smithy/core/client").CommandImpl<ListDeviceFleetsCommandInput, ListDeviceFleetsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListDeviceFleetsCommandInput]): import("@smithy/core/client").CommandImpl<ListDeviceFleetsCommandInput, ListDeviceFleetsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
