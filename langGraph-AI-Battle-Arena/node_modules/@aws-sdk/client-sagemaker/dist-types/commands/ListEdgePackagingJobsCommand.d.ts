...
declare const ListEdgePackagingJobsCommand_base: {
    new (input: ListEdgePackagingJobsCommandInput): import("@smithy/core/client").CommandImpl<ListEdgePackagingJobsCommandInput, ListEdgePackagingJobsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListEdgePackagingJobsCommandInput]): import("@smithy/core/client").CommandImpl<ListEdgePackagingJobsCommandInput, ListEdgePackagingJobsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
