...
declare const DeleteEdgeDeploymentPlanCommand_base: {
    new (input: DeleteEdgeDeploymentPlanCommandInput): import("@smithy/core/client").CommandImpl<DeleteEdgeDeploymentPlanCommandInput, DeleteEdgeDeploymentPlanCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteEdgeDeploymentPlanCommandInput): import("@smithy/core/client").CommandImpl<DeleteEdgeDeploymentPlanCommandInput, DeleteEdgeDeploymentPlanCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
