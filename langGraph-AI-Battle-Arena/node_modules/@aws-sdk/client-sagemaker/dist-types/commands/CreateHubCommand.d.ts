...
declare const CreateHubCommand_base: {
    new (input: CreateHubCommandInput): import("@smithy/core/client").CommandImpl<CreateHubCommandInput, CreateHubCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateHubCommandInput): import("@smithy/core/client").CommandImpl<CreateHubCommandInput, CreateHubCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
