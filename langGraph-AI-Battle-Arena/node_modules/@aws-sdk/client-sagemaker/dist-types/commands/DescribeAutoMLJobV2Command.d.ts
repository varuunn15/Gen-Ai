...
declare const DescribeAutoMLJobV2Command_base: {
    new (input: DescribeAutoMLJobV2CommandInput): import("@smithy/core/client").CommandImpl<DescribeAutoMLJobV2CommandInput, DescribeAutoMLJobV2CommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeAutoMLJobV2CommandInput): import("@smithy/core/client").CommandImpl<DescribeAutoMLJobV2CommandInput, DescribeAutoMLJobV2CommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
