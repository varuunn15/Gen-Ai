...
declare const StopPipelineExecutionCommand_base: {
    new (input: StopPipelineExecutionCommandInput): import("@smithy/core/client").CommandImpl<StopPipelineExecutionCommandInput, StopPipelineExecutionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopPipelineExecutionCommandInput): import("@smithy/core/client").CommandImpl<StopPipelineExecutionCommandInput, StopPipelineExecutionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
