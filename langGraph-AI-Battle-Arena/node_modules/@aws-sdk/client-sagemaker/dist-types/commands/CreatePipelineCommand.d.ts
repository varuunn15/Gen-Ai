...
declare const CreatePipelineCommand_base: {
    new (input: CreatePipelineCommandInput): import("@smithy/core/client").CommandImpl<CreatePipelineCommandInput, CreatePipelineCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreatePipelineCommandInput): import("@smithy/core/client").CommandImpl<CreatePipelineCommandInput, CreatePipelineCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
