...
declare const StartEdgeDeploymentStageCommand_base: {
    new (input: StartEdgeDeploymentStageCommandInput): import("@smithy/core/client").CommandImpl<StartEdgeDeploymentStageCommandInput, StartEdgeDeploymentStageCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartEdgeDeploymentStageCommandInput): import("@smithy/core/client").CommandImpl<StartEdgeDeploymentStageCommandInput, StartEdgeDeploymentStageCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
