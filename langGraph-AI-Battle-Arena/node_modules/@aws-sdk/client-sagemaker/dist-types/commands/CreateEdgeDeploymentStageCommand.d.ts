...
declare const CreateEdgeDeploymentStageCommand_base: {
    new (input: CreateEdgeDeploymentStageCommandInput): import("@smithy/core/client").CommandImpl<CreateEdgeDeploymentStageCommandInput, CreateEdgeDeploymentStageCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateEdgeDeploymentStageCommandInput): import("@smithy/core/client").CommandImpl<CreateEdgeDeploymentStageCommandInput, CreateEdgeDeploymentStageCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
