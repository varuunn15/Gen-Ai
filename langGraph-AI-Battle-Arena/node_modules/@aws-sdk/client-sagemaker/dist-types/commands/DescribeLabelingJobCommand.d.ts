...
declare const DescribeLabelingJobCommand_base: {
    new (input: DescribeLabelingJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeLabelingJobCommandInput, DescribeLabelingJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeLabelingJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeLabelingJobCommandInput, DescribeLabelingJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
