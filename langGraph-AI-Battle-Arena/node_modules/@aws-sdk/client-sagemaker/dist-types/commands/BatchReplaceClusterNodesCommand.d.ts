...
declare const BatchReplaceClusterNodesCommand_base: {
    new (input: BatchReplaceClusterNodesCommandInput): import("@smithy/core/client").CommandImpl<BatchReplaceClusterNodesCommandInput, BatchReplaceClusterNodesCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BatchReplaceClusterNodesCommandInput): import("@smithy/core/client").CommandImpl<BatchReplaceClusterNodesCommandInput, BatchReplaceClusterNodesCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
