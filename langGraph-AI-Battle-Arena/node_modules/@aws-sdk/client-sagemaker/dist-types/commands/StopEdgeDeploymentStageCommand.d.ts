...
declare const StopEdgeDeploymentStageCommand_base: {
    new (input: StopEdgeDeploymentStageCommandInput): import("@smithy/core/client").CommandImpl<StopEdgeDeploymentStageCommandInput, StopEdgeDeploymentStageCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopEdgeDeploymentStageCommandInput): import("@smithy/core/client").CommandImpl<StopEdgeDeploymentStageCommandInput, StopEdgeDeploymentStageCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
