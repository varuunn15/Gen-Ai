...
declare const DescribeFlowDefinitionCommand_base: {
    new (input: DescribeFlowDefinitionCommandInput): import("@smithy/core/client").CommandImpl<DescribeFlowDefinitionCommandInput, DescribeFlowDefinitionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeFlowDefinitionCommandInput): import("@smithy/core/client").CommandImpl<DescribeFlowDefinitionCommandInput, DescribeFlowDefinitionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
