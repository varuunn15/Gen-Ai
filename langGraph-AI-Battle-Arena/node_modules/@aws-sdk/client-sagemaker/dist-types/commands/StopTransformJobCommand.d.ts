...
declare const StopTransformJobCommand_base: {
    new (input: StopTransformJobCommandInput): import("@smithy/core/client").CommandImpl<StopTransformJobCommandInput, StopTransformJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopTransformJobCommandInput): import("@smithy/core/client").CommandImpl<StopTransformJobCommandInput, StopTransformJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
