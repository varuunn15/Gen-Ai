...
declare const StartMlflowTrackingServerCommand_base: {
    new (input: StartMlflowTrackingServerCommandInput): import("@smithy/core/client").CommandImpl<StartMlflowTrackingServerCommandInput, StartMlflowTrackingServerCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartMlflowTrackingServerCommandInput): import("@smithy/core/client").CommandImpl<StartMlflowTrackingServerCommandInput, StartMlflowTrackingServerCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
