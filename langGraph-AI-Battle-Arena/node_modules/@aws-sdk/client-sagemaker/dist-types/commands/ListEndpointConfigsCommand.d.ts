...
declare const ListEndpointConfigsCommand_base: {
    new (input: ListEndpointConfigsCommandInput): import("@smithy/core/client").CommandImpl<ListEndpointConfigsCommandInput, ListEndpointConfigsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListEndpointConfigsCommandInput]): import("@smithy/core/client").CommandImpl<ListEndpointConfigsCommandInput, ListEndpointConfigsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
