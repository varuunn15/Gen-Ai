...
declare const ListAIWorkloadConfigsCommand_base: {
    new (input: ListAIWorkloadConfigsCommandInput): import("@smithy/core/client").CommandImpl<ListAIWorkloadConfigsCommandInput, ListAIWorkloadConfigsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListAIWorkloadConfigsCommandInput]): import("@smithy/core/client").CommandImpl<ListAIWorkloadConfigsCommandInput, ListAIWorkloadConfigsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
