...
declare const DeleteEdgeDeploymentStageCommand_base: {
    new (input: DeleteEdgeDeploymentStageCommandInput): import("@smithy/core/client").CommandImpl<DeleteEdgeDeploymentStageCommandInput, DeleteEdgeDeploymentStageCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteEdgeDeploymentStageCommandInput): import("@smithy/core/client").CommandImpl<DeleteEdgeDeploymentStageCommandInput, DeleteEdgeDeploymentStageCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
