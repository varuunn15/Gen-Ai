...
declare const DeleteFeatureGroupCommand_base: {
    new (input: DeleteFeatureGroupCommandInput): import("@smithy/core/client").CommandImpl<DeleteFeatureGroupCommandInput, DeleteFeatureGroupCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteFeatureGroupCommandInput): import("@smithy/core/client").CommandImpl<DeleteFeatureGroupCommandInput, DeleteFeatureGroupCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
