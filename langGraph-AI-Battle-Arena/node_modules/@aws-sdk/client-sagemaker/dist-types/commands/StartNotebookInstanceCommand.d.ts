...
declare const StartNotebookInstanceCommand_base: {
    new (input: StartNotebookInstanceCommandInput): import("@smithy/core/client").CommandImpl<StartNotebookInstanceCommandInput, StartNotebookInstanceCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartNotebookInstanceCommandInput): import("@smithy/core/client").CommandImpl<StartNotebookInstanceCommandInput, StartNotebookInstanceCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
