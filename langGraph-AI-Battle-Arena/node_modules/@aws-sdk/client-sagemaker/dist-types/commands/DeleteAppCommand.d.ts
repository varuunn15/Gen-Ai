...
declare const DeleteAppCommand_base: {
    new (input: DeleteAppCommandInput): import("@smithy/core/client").CommandImpl<DeleteAppCommandInput, DeleteAppCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteAppCommandInput): import("@smithy/core/client").CommandImpl<DeleteAppCommandInput, DeleteAppCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
