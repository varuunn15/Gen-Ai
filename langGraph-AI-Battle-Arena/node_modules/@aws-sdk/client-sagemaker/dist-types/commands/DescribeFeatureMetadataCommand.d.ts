...
declare const DescribeFeatureMetadataCommand_base: {
    new (input: DescribeFeatureMetadataCommandInput): import("@smithy/core/client").CommandImpl<DescribeFeatureMetadataCommandInput, DescribeFeatureMetadataCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeFeatureMetadataCommandInput): import("@smithy/core/client").CommandImpl<DescribeFeatureMetadataCommandInput, DescribeFeatureMetadataCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
