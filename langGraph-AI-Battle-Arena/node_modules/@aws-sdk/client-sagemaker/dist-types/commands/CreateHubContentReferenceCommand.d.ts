...
declare const CreateHubContentReferenceCommand_base: {
    new (input: CreateHubContentReferenceCommandInput): import("@smithy/core/client").CommandImpl<CreateHubContentReferenceCommandInput, CreateHubContentReferenceCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateHubContentReferenceCommandInput): import("@smithy/core/client").CommandImpl<CreateHubContentReferenceCommandInput, CreateHubContentReferenceCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
