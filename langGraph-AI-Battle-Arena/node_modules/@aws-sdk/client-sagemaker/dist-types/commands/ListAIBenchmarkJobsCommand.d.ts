...
declare const ListAIBenchmarkJobsCommand_base: {
    new (input: ListAIBenchmarkJobsCommandInput): import("@smithy/core/client").CommandImpl<ListAIBenchmarkJobsCommandInput, ListAIBenchmarkJobsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListAIBenchmarkJobsCommandInput]): import("@smithy/core/client").CommandImpl<ListAIBenchmarkJobsCommandInput, ListAIBenchmarkJobsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
