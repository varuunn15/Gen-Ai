...
declare const DeleteTrialComponentCommand_base: {
    new (input: DeleteTrialComponentCommandInput): import("@smithy/core/client").CommandImpl<DeleteTrialComponentCommandInput, DeleteTrialComponentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteTrialComponentCommandInput): import("@smithy/core/client").CommandImpl<DeleteTrialComponentCommandInput, DeleteTrialComponentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
