...
declare const RetryPipelineExecutionCommand_base: {
    new (input: RetryPipelineExecutionCommandInput): import("@smithy/core/client").CommandImpl<RetryPipelineExecutionCommandInput, RetryPipelineExecutionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RetryPipelineExecutionCommandInput): import("@smithy/core/client").CommandImpl<RetryPipelineExecutionCommandInput, RetryPipelineExecutionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
