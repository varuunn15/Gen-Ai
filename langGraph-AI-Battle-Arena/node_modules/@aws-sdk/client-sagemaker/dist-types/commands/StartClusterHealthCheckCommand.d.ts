...
declare const StartClusterHealthCheckCommand_base: {
    new (input: StartClusterHealthCheckCommandInput): import("@smithy/core/client").CommandImpl<StartClusterHealthCheckCommandInput, StartClusterHealthCheckCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartClusterHealthCheckCommandInput): import("@smithy/core/client").CommandImpl<StartClusterHealthCheckCommandInput, StartClusterHealthCheckCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
