...
declare const DeleteUserProfileCommand_base: {
    new (input: DeleteUserProfileCommandInput): import("@smithy/core/client").CommandImpl<DeleteUserProfileCommandInput, DeleteUserProfileCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteUserProfileCommandInput): import("@smithy/core/client").CommandImpl<DeleteUserProfileCommandInput, DeleteUserProfileCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
