...
declare const CreateAIWorkloadConfigCommand_base: {
    new (input: CreateAIWorkloadConfigCommandInput): import("@smithy/core/client").CommandImpl<CreateAIWorkloadConfigCommandInput, CreateAIWorkloadConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateAIWorkloadConfigCommandInput): import("@smithy/core/client").CommandImpl<CreateAIWorkloadConfigCommandInput, CreateAIWorkloadConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
