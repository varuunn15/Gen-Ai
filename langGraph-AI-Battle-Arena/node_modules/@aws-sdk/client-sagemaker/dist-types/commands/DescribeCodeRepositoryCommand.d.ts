...
declare const DescribeCodeRepositoryCommand_base: {
    new (input: DescribeCodeRepositoryCommandInput): import("@smithy/core/client").CommandImpl<DescribeCodeRepositoryCommandInput, DescribeCodeRepositoryCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeCodeRepositoryCommandInput): import("@smithy/core/client").CommandImpl<DescribeCodeRepositoryCommandInput, DescribeCodeRepositoryCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
