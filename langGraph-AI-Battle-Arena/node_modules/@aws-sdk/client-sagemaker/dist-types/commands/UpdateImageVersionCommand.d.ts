...
declare const UpdateImageVersionCommand_base: {
    new (input: UpdateImageVersionCommandInput): import("@smithy/core/client").CommandImpl<UpdateImageVersionCommandInput, UpdateImageVersionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateImageVersionCommandInput): import("@smithy/core/client").CommandImpl<UpdateImageVersionCommandInput, UpdateImageVersionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
