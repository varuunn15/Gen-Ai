...
declare const DeleteDeviceFleetCommand_base: {
    new (input: DeleteDeviceFleetCommandInput): import("@smithy/core/client").CommandImpl<DeleteDeviceFleetCommandInput, DeleteDeviceFleetCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteDeviceFleetCommandInput): import("@smithy/core/client").CommandImpl<DeleteDeviceFleetCommandInput, DeleteDeviceFleetCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
