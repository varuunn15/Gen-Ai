...
declare const ListAliasesCommand_base: {
    new (input: ListAliasesCommandInput): import("@smithy/core/client").CommandImpl<ListAliasesCommandInput, ListAliasesCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListAliasesCommandInput): import("@smithy/core/client").CommandImpl<ListAliasesCommandInput, ListAliasesCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
