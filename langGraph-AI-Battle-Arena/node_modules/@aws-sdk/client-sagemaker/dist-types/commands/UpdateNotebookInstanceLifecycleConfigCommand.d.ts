...
declare const UpdateNotebookInstanceLifecycleConfigCommand_base: {
    new (input: UpdateNotebookInstanceLifecycleConfigCommandInput): import("@smithy/core/client").CommandImpl<UpdateNotebookInstanceLifecycleConfigCommandInput, UpdateNotebookInstanceLifecycleConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateNotebookInstanceLifecycleConfigCommandInput): import("@smithy/core/client").CommandImpl<UpdateNotebookInstanceLifecycleConfigCommandInput, UpdateNotebookInstanceLifecycleConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
