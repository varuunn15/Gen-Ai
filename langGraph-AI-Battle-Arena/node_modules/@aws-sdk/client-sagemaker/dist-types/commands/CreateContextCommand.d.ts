...
declare const CreateContextCommand_base: {
    new (input: CreateContextCommandInput): import("@smithy/core/client").CommandImpl<CreateContextCommandInput, CreateContextCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateContextCommandInput): import("@smithy/core/client").CommandImpl<CreateContextCommandInput, CreateContextCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
