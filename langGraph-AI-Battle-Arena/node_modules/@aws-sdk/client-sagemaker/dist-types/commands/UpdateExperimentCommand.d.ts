...
declare const UpdateExperimentCommand_base: {
    new (input: UpdateExperimentCommandInput): import("@smithy/core/client").CommandImpl<UpdateExperimentCommandInput, UpdateExperimentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateExperimentCommandInput): import("@smithy/core/client").CommandImpl<UpdateExperimentCommandInput, UpdateExperimentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
