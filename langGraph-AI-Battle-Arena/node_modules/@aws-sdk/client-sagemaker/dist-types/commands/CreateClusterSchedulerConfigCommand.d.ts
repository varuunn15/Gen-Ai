...
declare const CreateClusterSchedulerConfigCommand_base: {
    new (input: CreateClusterSchedulerConfigCommandInput): import("@smithy/core/client").CommandImpl<CreateClusterSchedulerConfigCommandInput, CreateClusterSchedulerConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateClusterSchedulerConfigCommandInput): import("@smithy/core/client").CommandImpl<CreateClusterSchedulerConfigCommandInput, CreateClusterSchedulerConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
