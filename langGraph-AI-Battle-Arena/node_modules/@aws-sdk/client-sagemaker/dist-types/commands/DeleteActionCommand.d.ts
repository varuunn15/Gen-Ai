...
declare const DeleteActionCommand_base: {
    new (input: DeleteActionCommandInput): import("@smithy/core/client").CommandImpl<DeleteActionCommandInput, DeleteActionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteActionCommandInput): import("@smithy/core/client").CommandImpl<DeleteActionCommandInput, DeleteActionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
