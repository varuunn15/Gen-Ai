...
declare const CreateAIBenchmarkJobCommand_base: {
    new (input: CreateAIBenchmarkJobCommandInput): import("@smithy/core/client").CommandImpl<CreateAIBenchmarkJobCommandInput, CreateAIBenchmarkJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateAIBenchmarkJobCommandInput): import("@smithy/core/client").CommandImpl<CreateAIBenchmarkJobCommandInput, CreateAIBenchmarkJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
