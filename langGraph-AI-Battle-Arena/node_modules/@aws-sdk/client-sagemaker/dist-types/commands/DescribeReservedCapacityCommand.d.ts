...
declare const DescribeReservedCapacityCommand_base: {
    new (input: DescribeReservedCapacityCommandInput): import("@smithy/core/client").CommandImpl<DescribeReservedCapacityCommandInput, DescribeReservedCapacityCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeReservedCapacityCommandInput): import("@smithy/core/client").CommandImpl<DescribeReservedCapacityCommandInput, DescribeReservedCapacityCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
