...
declare const DetachClusterNodeVolumeCommand_base: {
    new (input: DetachClusterNodeVolumeCommandInput): import("@smithy/core/client").CommandImpl<DetachClusterNodeVolumeCommandInput, DetachClusterNodeVolumeCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DetachClusterNodeVolumeCommandInput): import("@smithy/core/client").CommandImpl<DetachClusterNodeVolumeCommandInput, DetachClusterNodeVolumeCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
