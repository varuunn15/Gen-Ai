...
declare const DescribeWorkforceCommand_base: {
    new (input: DescribeWorkforceCommandInput): import("@smithy/core/client").CommandImpl<DescribeWorkforceCommandInput, DescribeWorkforceCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeWorkforceCommandInput): import("@smithy/core/client").CommandImpl<DescribeWorkforceCommandInput, DescribeWorkforceCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
