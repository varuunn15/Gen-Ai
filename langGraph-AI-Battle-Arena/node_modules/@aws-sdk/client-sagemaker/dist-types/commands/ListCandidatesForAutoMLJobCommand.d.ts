...
declare const ListCandidatesForAutoMLJobCommand_base: {
    new (input: ListCandidatesForAutoMLJobCommandInput): import("@smithy/core/client").CommandImpl<ListCandidatesForAutoMLJobCommandInput, ListCandidatesForAutoMLJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListCandidatesForAutoMLJobCommandInput): import("@smithy/core/client").CommandImpl<ListCandidatesForAutoMLJobCommandInput, ListCandidatesForAutoMLJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
