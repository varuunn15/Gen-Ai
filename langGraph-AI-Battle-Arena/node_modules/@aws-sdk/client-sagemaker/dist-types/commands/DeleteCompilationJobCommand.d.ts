...
declare const DeleteCompilationJobCommand_base: {
    new (input: DeleteCompilationJobCommandInput): import("@smithy/core/client").CommandImpl<DeleteCompilationJobCommandInput, DeleteCompilationJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteCompilationJobCommandInput): import("@smithy/core/client").CommandImpl<DeleteCompilationJobCommandInput, DeleteCompilationJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
