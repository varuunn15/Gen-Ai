...
declare const DeleteInferenceExperimentCommand_base: {
    new (input: DeleteInferenceExperimentCommandInput): import("@smithy/core/client").CommandImpl<DeleteInferenceExperimentCommandInput, DeleteInferenceExperimentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteInferenceExperimentCommandInput): import("@smithy/core/client").CommandImpl<DeleteInferenceExperimentCommandInput, DeleteInferenceExperimentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
