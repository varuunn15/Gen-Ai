...
declare const DescribeExperimentCommand_base: {
    new (input: DescribeExperimentCommandInput): import("@smithy/core/client").CommandImpl<DescribeExperimentCommandInput, DescribeExperimentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeExperimentCommandInput): import("@smithy/core/client").CommandImpl<DescribeExperimentCommandInput, DescribeExperimentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
