...
declare const StopMlflowTrackingServerCommand_base: {
    new (input: StopMlflowTrackingServerCommandInput): import("@smithy/core/client").CommandImpl<StopMlflowTrackingServerCommandInput, StopMlflowTrackingServerCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopMlflowTrackingServerCommandInput): import("@smithy/core/client").CommandImpl<StopMlflowTrackingServerCommandInput, StopMlflowTrackingServerCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
