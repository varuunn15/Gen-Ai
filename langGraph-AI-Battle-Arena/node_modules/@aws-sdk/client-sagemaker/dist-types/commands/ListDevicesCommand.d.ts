...
declare const ListDevicesCommand_base: {
    new (input: ListDevicesCommandInput): import("@smithy/core/client").CommandImpl<ListDevicesCommandInput, ListDevicesCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListDevicesCommandInput]): import("@smithy/core/client").CommandImpl<ListDevicesCommandInput, ListDevicesCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
