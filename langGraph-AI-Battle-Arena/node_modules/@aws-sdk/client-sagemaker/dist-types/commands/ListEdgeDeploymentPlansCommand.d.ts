...
declare const ListEdgeDeploymentPlansCommand_base: {
    new (input: ListEdgeDeploymentPlansCommandInput): import("@smithy/core/client").CommandImpl<ListEdgeDeploymentPlansCommandInput, ListEdgeDeploymentPlansCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListEdgeDeploymentPlansCommandInput]): import("@smithy/core/client").CommandImpl<ListEdgeDeploymentPlansCommandInput, ListEdgeDeploymentPlansCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
