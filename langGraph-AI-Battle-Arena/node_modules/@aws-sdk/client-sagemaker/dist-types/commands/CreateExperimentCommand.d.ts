...
declare const CreateExperimentCommand_base: {
    new (input: CreateExperimentCommandInput): import("@smithy/core/client").CommandImpl<CreateExperimentCommandInput, CreateExperimentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateExperimentCommandInput): import("@smithy/core/client").CommandImpl<CreateExperimentCommandInput, CreateExperimentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
