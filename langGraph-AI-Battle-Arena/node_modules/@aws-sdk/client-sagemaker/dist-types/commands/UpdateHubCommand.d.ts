...
declare const UpdateHubCommand_base: {
    new (input: UpdateHubCommandInput): import("@smithy/core/client").CommandImpl<UpdateHubCommandInput, UpdateHubCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateHubCommandInput): import("@smithy/core/client").CommandImpl<UpdateHubCommandInput, UpdateHubCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
