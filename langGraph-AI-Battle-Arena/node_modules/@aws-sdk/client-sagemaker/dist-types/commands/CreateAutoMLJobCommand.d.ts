...
declare const CreateAutoMLJobCommand_base: {
    new (input: CreateAutoMLJobCommandInput): import("@smithy/core/client").CommandImpl<CreateAutoMLJobCommandInput, CreateAutoMLJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateAutoMLJobCommandInput): import("@smithy/core/client").CommandImpl<CreateAutoMLJobCommandInput, CreateAutoMLJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
