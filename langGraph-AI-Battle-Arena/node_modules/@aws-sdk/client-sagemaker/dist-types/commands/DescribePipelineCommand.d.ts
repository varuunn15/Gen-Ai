...
declare const DescribePipelineCommand_base: {
    new (input: DescribePipelineCommandInput): import("@smithy/core/client").CommandImpl<DescribePipelineCommandInput, DescribePipelineCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribePipelineCommandInput): import("@smithy/core/client").CommandImpl<DescribePipelineCommandInput, DescribePipelineCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
