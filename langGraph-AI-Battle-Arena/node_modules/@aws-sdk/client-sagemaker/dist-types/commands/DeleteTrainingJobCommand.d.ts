...
declare const DeleteTrainingJobCommand_base: {
    new (input: DeleteTrainingJobCommandInput): import("@smithy/core/client").CommandImpl<DeleteTrainingJobCommandInput, DeleteTrainingJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteTrainingJobCommandInput): import("@smithy/core/client").CommandImpl<DeleteTrainingJobCommandInput, DeleteTrainingJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
