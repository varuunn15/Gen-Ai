...
declare const DeleteHubContentCommand_base: {
    new (input: DeleteHubContentCommandInput): import("@smithy/core/client").CommandImpl<DeleteHubContentCommandInput, DeleteHubContentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteHubContentCommandInput): import("@smithy/core/client").CommandImpl<DeleteHubContentCommandInput, DeleteHubContentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
