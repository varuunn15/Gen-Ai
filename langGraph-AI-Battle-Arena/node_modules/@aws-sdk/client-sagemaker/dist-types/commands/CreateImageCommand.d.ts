...
declare const CreateImageCommand_base: {
    new (input: CreateImageCommandInput): import("@smithy/core/client").CommandImpl<CreateImageCommandInput, CreateImageCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateImageCommandInput): import("@smithy/core/client").CommandImpl<CreateImageCommandInput, CreateImageCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
