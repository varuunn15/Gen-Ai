...
declare const DeleteImageVersionCommand_base: {
    new (input: DeleteImageVersionCommandInput): import("@smithy/core/client").CommandImpl<DeleteImageVersionCommandInput, DeleteImageVersionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteImageVersionCommandInput): import("@smithy/core/client").CommandImpl<DeleteImageVersionCommandInput, DeleteImageVersionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
