...
declare const CreateWorkforceCommand_base: {
    new (input: CreateWorkforceCommandInput): import("@smithy/core/client").CommandImpl<CreateWorkforceCommandInput, CreateWorkforceCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateWorkforceCommandInput): import("@smithy/core/client").CommandImpl<CreateWorkforceCommandInput, CreateWorkforceCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
