...
declare const UpdatePipelineCommand_base: {
    new (input: UpdatePipelineCommandInput): import("@smithy/core/client").CommandImpl<UpdatePipelineCommandInput, UpdatePipelineCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdatePipelineCommandInput): import("@smithy/core/client").CommandImpl<UpdatePipelineCommandInput, UpdatePipelineCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
