...
declare const ListEndpointsCommand_base: {
    new (input: ListEndpointsCommandInput): import("@smithy/core/client").CommandImpl<ListEndpointsCommandInput, ListEndpointsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListEndpointsCommandInput]): import("@smithy/core/client").CommandImpl<ListEndpointsCommandInput, ListEndpointsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
