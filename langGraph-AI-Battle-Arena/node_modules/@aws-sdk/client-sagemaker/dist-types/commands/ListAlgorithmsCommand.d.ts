...
declare const ListAlgorithmsCommand_base: {
    new (input: ListAlgorithmsCommandInput): import("@smithy/core/client").CommandImpl<ListAlgorithmsCommandInput, ListAlgorithmsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListAlgorithmsCommandInput]): import("@smithy/core/client").CommandImpl<ListAlgorithmsCommandInput, ListAlgorithmsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
