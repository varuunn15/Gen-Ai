...
declare const DescribeTrainingPlanCommand_base: {
    new (input: DescribeTrainingPlanCommandInput): import("@smithy/core/client").CommandImpl<DescribeTrainingPlanCommandInput, DescribeTrainingPlanCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeTrainingPlanCommandInput): import("@smithy/core/client").CommandImpl<DescribeTrainingPlanCommandInput, DescribeTrainingPlanCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
