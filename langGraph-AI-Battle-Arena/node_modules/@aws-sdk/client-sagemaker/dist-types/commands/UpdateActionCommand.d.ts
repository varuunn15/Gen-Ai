...
declare const UpdateActionCommand_base: {
    new (input: UpdateActionCommandInput): import("@smithy/core/client").CommandImpl<UpdateActionCommandInput, UpdateActionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateActionCommandInput): import("@smithy/core/client").CommandImpl<UpdateActionCommandInput, UpdateActionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
