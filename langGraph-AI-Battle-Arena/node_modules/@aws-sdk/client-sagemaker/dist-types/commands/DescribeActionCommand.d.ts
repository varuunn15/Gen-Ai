...
declare const DescribeActionCommand_base: {
    new (input: DescribeActionCommandInput): import("@smithy/core/client").CommandImpl<DescribeActionCommandInput, DescribeActionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeActionCommandInput): import("@smithy/core/client").CommandImpl<DescribeActionCommandInput, DescribeActionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
