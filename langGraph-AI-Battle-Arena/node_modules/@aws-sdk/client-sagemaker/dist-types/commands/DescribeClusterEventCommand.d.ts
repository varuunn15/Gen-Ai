...
declare const DescribeClusterEventCommand_base: {
    new (input: DescribeClusterEventCommandInput): import("@smithy/core/client").CommandImpl<DescribeClusterEventCommandInput, DescribeClusterEventCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeClusterEventCommandInput): import("@smithy/core/client").CommandImpl<DescribeClusterEventCommandInput, DescribeClusterEventCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
