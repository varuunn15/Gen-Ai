...
declare const SendPipelineExecutionStepFailureCommand_base: {
    new (input: SendPipelineExecutionStepFailureCommandInput): import("@smithy/core/client").CommandImpl<SendPipelineExecutionStepFailureCommandInput, SendPipelineExecutionStepFailureCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SendPipelineExecutionStepFailureCommandInput): import("@smithy/core/client").CommandImpl<SendPipelineExecutionStepFailureCommandInput, SendPipelineExecutionStepFailureCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
