...
declare const ImportHubContentCommand_base: {
    new (input: ImportHubContentCommandInput): import("@smithy/core/client").CommandImpl<ImportHubContentCommandInput, ImportHubContentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ImportHubContentCommandInput): import("@smithy/core/client").CommandImpl<ImportHubContentCommandInput, ImportHubContentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
