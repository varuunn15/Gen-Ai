...
declare const CreateEndpointCommand_base: {
    new (input: CreateEndpointCommandInput): import("@smithy/core/client").CommandImpl<CreateEndpointCommandInput, CreateEndpointCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateEndpointCommandInput): import("@smithy/core/client").CommandImpl<CreateEndpointCommandInput, CreateEndpointCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
