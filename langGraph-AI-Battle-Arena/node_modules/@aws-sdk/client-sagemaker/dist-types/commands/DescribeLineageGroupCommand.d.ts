...
declare const DescribeLineageGroupCommand_base: {
    new (input: DescribeLineageGroupCommandInput): import("@smithy/core/client").CommandImpl<DescribeLineageGroupCommandInput, DescribeLineageGroupCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeLineageGroupCommandInput): import("@smithy/core/client").CommandImpl<DescribeLineageGroupCommandInput, DescribeLineageGroupCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
