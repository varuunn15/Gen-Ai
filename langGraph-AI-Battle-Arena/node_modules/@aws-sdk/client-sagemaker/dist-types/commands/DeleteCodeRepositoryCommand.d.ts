...
declare const DeleteCodeRepositoryCommand_base: {
    new (input: DeleteCodeRepositoryCommandInput): import("@smithy/core/client").CommandImpl<DeleteCodeRepositoryCommandInput, DeleteCodeRepositoryCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteCodeRepositoryCommandInput): import("@smithy/core/client").CommandImpl<DeleteCodeRepositoryCommandInput, DeleteCodeRepositoryCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
