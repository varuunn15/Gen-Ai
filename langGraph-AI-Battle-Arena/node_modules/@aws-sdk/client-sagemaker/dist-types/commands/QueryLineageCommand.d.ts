...
declare const QueryLineageCommand_base: {
    new (input: QueryLineageCommandInput): import("@smithy/core/client").CommandImpl<QueryLineageCommandInput, QueryLineageCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [QueryLineageCommandInput]): import("@smithy/core/client").CommandImpl<QueryLineageCommandInput, QueryLineageCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
