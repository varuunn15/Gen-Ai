...
declare const GetModelPackageGroupPolicyCommand_base: {
    new (input: GetModelPackageGroupPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetModelPackageGroupPolicyCommandInput, GetModelPackageGroupPolicyCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetModelPackageGroupPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetModelPackageGroupPolicyCommandInput, GetModelPackageGroupPolicyCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
