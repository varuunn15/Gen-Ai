...
declare const UpdateContextCommand_base: {
    new (input: UpdateContextCommandInput): import("@smithy/core/client").CommandImpl<UpdateContextCommandInput, UpdateContextCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateContextCommandInput): import("@smithy/core/client").CommandImpl<UpdateContextCommandInput, UpdateContextCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
