...
declare const DeleteHubContentReferenceCommand_base: {
    new (input: DeleteHubContentReferenceCommandInput): import("@smithy/core/client").CommandImpl<DeleteHubContentReferenceCommandInput, DeleteHubContentReferenceCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteHubContentReferenceCommandInput): import("@smithy/core/client").CommandImpl<DeleteHubContentReferenceCommandInput, DeleteHubContentReferenceCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
