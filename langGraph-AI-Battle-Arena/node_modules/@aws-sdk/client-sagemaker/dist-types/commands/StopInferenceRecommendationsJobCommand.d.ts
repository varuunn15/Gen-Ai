...
declare const StopInferenceRecommendationsJobCommand_base: {
    new (input: StopInferenceRecommendationsJobCommandInput): import("@smithy/core/client").CommandImpl<StopInferenceRecommendationsJobCommandInput, StopInferenceRecommendationsJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopInferenceRecommendationsJobCommandInput): import("@smithy/core/client").CommandImpl<StopInferenceRecommendationsJobCommandInput, StopInferenceRecommendationsJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
