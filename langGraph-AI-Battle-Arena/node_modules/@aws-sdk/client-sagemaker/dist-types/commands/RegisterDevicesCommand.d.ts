...
declare const RegisterDevicesCommand_base: {
    new (input: RegisterDevicesCommandInput): import("@smithy/core/client").CommandImpl<RegisterDevicesCommandInput, RegisterDevicesCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RegisterDevicesCommandInput): import("@smithy/core/client").CommandImpl<RegisterDevicesCommandInput, RegisterDevicesCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
