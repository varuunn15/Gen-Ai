...
declare const DescribePipelineExecutionCommand_base: {
    new (input: DescribePipelineExecutionCommandInput): import("@smithy/core/client").CommandImpl<DescribePipelineExecutionCommandInput, DescribePipelineExecutionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribePipelineExecutionCommandInput): import("@smithy/core/client").CommandImpl<DescribePipelineExecutionCommandInput, DescribePipelineExecutionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
