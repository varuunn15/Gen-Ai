...
declare const DescribeImageCommand_base: {
    new (input: DescribeImageCommandInput): import("@smithy/core/client").CommandImpl<DescribeImageCommandInput, DescribeImageCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeImageCommandInput): import("@smithy/core/client").CommandImpl<DescribeImageCommandInput, DescribeImageCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
