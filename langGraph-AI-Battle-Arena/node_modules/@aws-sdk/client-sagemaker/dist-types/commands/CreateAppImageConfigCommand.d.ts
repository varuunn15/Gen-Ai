...
declare const CreateAppImageConfigCommand_base: {
    new (input: CreateAppImageConfigCommandInput): import("@smithy/core/client").CommandImpl<CreateAppImageConfigCommandInput, CreateAppImageConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateAppImageConfigCommandInput): import("@smithy/core/client").CommandImpl<CreateAppImageConfigCommandInput, CreateAppImageConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
