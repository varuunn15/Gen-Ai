...
declare const DescribeContextCommand_base: {
    new (input: DescribeContextCommandInput): import("@smithy/core/client").CommandImpl<DescribeContextCommandInput, DescribeContextCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeContextCommandInput): import("@smithy/core/client").CommandImpl<DescribeContextCommandInput, DescribeContextCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
