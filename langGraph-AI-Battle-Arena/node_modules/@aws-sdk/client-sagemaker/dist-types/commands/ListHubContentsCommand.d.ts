...
declare const ListHubContentsCommand_base: {
    new (input: ListHubContentsCommandInput): import("@smithy/core/client").CommandImpl<ListHubContentsCommandInput, ListHubContentsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListHubContentsCommandInput): import("@smithy/core/client").CommandImpl<ListHubContentsCommandInput, ListHubContentsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
