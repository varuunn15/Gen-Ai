...
declare const ListAutoMLJobsCommand_base: {
    new (input: ListAutoMLJobsCommandInput): import("@smithy/core/client").CommandImpl<ListAutoMLJobsCommandInput, ListAutoMLJobsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListAutoMLJobsCommandInput]): import("@smithy/core/client").CommandImpl<ListAutoMLJobsCommandInput, ListAutoMLJobsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
