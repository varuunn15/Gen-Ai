...
declare const DeleteAIWorkloadConfigCommand_base: {
    new (input: DeleteAIWorkloadConfigCommandInput): import("@smithy/core/client").CommandImpl<DeleteAIWorkloadConfigCommandInput, DeleteAIWorkloadConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteAIWorkloadConfigCommandInput): import("@smithy/core/client").CommandImpl<DeleteAIWorkloadConfigCommandInput, DeleteAIWorkloadConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
