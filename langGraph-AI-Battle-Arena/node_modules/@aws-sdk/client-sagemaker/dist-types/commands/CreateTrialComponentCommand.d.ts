...
declare const CreateTrialComponentCommand_base: {
    new (input: CreateTrialComponentCommandInput): import("@smithy/core/client").CommandImpl<CreateTrialComponentCommandInput, CreateTrialComponentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTrialComponentCommandInput): import("@smithy/core/client").CommandImpl<CreateTrialComponentCommandInput, CreateTrialComponentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
