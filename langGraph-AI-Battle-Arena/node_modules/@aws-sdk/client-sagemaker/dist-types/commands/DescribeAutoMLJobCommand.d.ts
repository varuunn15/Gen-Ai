...
declare const DescribeAutoMLJobCommand_base: {
    new (input: DescribeAutoMLJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeAutoMLJobCommandInput, DescribeAutoMLJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeAutoMLJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeAutoMLJobCommandInput, DescribeAutoMLJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
