...
declare const ListLabelingJobsForWorkteamCommand_base: {
    new (input: ListLabelingJobsForWorkteamCommandInput): import("@smithy/core/client").CommandImpl<ListLabelingJobsForWorkteamCommandInput, ListLabelingJobsForWorkteamCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListLabelingJobsForWorkteamCommandInput): import("@smithy/core/client").CommandImpl<ListLabelingJobsForWorkteamCommandInput, ListLabelingJobsForWorkteamCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
