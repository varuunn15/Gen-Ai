...
declare const StopMonitoringScheduleCommand_base: {
    new (input: StopMonitoringScheduleCommandInput): import("@smithy/core/client").CommandImpl<StopMonitoringScheduleCommandInput, StopMonitoringScheduleCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopMonitoringScheduleCommandInput): import("@smithy/core/client").CommandImpl<StopMonitoringScheduleCommandInput, StopMonitoringScheduleCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
