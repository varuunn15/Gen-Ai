...
declare const ListAppImageConfigsCommand_base: {
    new (input: ListAppImageConfigsCommandInput): import("@smithy/core/client").CommandImpl<ListAppImageConfigsCommandInput, ListAppImageConfigsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListAppImageConfigsCommandInput]): import("@smithy/core/client").CommandImpl<ListAppImageConfigsCommandInput, ListAppImageConfigsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
