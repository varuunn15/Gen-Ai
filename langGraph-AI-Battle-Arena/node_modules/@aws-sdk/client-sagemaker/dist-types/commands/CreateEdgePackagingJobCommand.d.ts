...
declare const CreateEdgePackagingJobCommand_base: {
    new (input: CreateEdgePackagingJobCommandInput): import("@smithy/core/client").CommandImpl<CreateEdgePackagingJobCommandInput, CreateEdgePackagingJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateEdgePackagingJobCommandInput): import("@smithy/core/client").CommandImpl<CreateEdgePackagingJobCommandInput, CreateEdgePackagingJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
