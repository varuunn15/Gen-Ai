...
declare const DeleteAlgorithmCommand_base: {
    new (input: DeleteAlgorithmCommandInput): import("@smithy/core/client").CommandImpl<DeleteAlgorithmCommandInput, DeleteAlgorithmCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteAlgorithmCommandInput): import("@smithy/core/client").CommandImpl<DeleteAlgorithmCommandInput, DeleteAlgorithmCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
