...
declare const DescribeDeviceFleetCommand_base: {
    new (input: DescribeDeviceFleetCommandInput): import("@smithy/core/client").CommandImpl<DescribeDeviceFleetCommandInput, DescribeDeviceFleetCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeDeviceFleetCommandInput): import("@smithy/core/client").CommandImpl<DescribeDeviceFleetCommandInput, DescribeDeviceFleetCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
