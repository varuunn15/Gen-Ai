...
declare const UpdateTrialComponentCommand_base: {
    new (input: UpdateTrialComponentCommandInput): import("@smithy/core/client").CommandImpl<UpdateTrialComponentCommandInput, UpdateTrialComponentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateTrialComponentCommandInput): import("@smithy/core/client").CommandImpl<UpdateTrialComponentCommandInput, UpdateTrialComponentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
