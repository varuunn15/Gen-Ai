...
declare const CreateFlowDefinitionCommand_base: {
    new (input: CreateFlowDefinitionCommandInput): import("@smithy/core/client").CommandImpl<CreateFlowDefinitionCommandInput, CreateFlowDefinitionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateFlowDefinitionCommandInput): import("@smithy/core/client").CommandImpl<CreateFlowDefinitionCommandInput, CreateFlowDefinitionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
