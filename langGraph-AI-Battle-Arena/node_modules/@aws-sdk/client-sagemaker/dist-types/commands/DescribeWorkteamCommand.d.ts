...
declare const DescribeWorkteamCommand_base: {
    new (input: DescribeWorkteamCommandInput): import("@smithy/core/client").CommandImpl<DescribeWorkteamCommandInput, DescribeWorkteamCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeWorkteamCommandInput): import("@smithy/core/client").CommandImpl<DescribeWorkteamCommandInput, DescribeWorkteamCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
