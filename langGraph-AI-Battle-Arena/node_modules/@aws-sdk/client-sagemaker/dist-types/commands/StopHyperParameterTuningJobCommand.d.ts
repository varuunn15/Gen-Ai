...
declare const StopHyperParameterTuningJobCommand_base: {
    new (input: StopHyperParameterTuningJobCommandInput): import("@smithy/core/client").CommandImpl<StopHyperParameterTuningJobCommandInput, StopHyperParameterTuningJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopHyperParameterTuningJobCommandInput): import("@smithy/core/client").CommandImpl<StopHyperParameterTuningJobCommandInput, StopHyperParameterTuningJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
