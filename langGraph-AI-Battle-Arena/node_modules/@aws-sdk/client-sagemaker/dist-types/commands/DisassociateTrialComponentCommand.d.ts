...
declare const DisassociateTrialComponentCommand_base: {
    new (input: DisassociateTrialComponentCommandInput): import("@smithy/core/client").CommandImpl<DisassociateTrialComponentCommandInput, DisassociateTrialComponentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisassociateTrialComponentCommandInput): import("@smithy/core/client").CommandImpl<DisassociateTrialComponentCommandInput, DisassociateTrialComponentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
