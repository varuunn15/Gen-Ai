...
declare const BatchRebootClusterNodesCommand_base: {
    new (input: BatchRebootClusterNodesCommandInput): import("@smithy/core/client").CommandImpl<BatchRebootClusterNodesCommandInput, BatchRebootClusterNodesCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BatchRebootClusterNodesCommandInput): import("@smithy/core/client").CommandImpl<BatchRebootClusterNodesCommandInput, BatchRebootClusterNodesCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
