...
declare const CreatePartnerAppPresignedUrlCommand_base: {
    new (input: CreatePartnerAppPresignedUrlCommandInput): import("@smithy/core/client").CommandImpl<CreatePartnerAppPresignedUrlCommandInput, CreatePartnerAppPresignedUrlCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreatePartnerAppPresignedUrlCommandInput): import("@smithy/core/client").CommandImpl<CreatePartnerAppPresignedUrlCommandInput, CreatePartnerAppPresignedUrlCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
