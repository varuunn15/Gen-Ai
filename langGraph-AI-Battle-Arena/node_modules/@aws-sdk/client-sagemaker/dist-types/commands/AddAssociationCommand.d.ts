...
declare const AddAssociationCommand_base: {
    new (input: AddAssociationCommandInput): import("@smithy/core/client").CommandImpl<AddAssociationCommandInput, AddAssociationCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AddAssociationCommandInput): import("@smithy/core/client").CommandImpl<AddAssociationCommandInput, AddAssociationCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
