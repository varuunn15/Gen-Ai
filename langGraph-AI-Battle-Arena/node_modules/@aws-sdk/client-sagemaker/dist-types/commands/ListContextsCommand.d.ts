...
declare const ListContextsCommand_base: {
    new (input: ListContextsCommandInput): import("@smithy/core/client").CommandImpl<ListContextsCommandInput, ListContextsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListContextsCommandInput]): import("@smithy/core/client").CommandImpl<ListContextsCommandInput, ListContextsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
