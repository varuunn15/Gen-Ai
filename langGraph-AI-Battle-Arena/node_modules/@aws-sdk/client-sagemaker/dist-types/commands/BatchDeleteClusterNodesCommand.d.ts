...
declare const BatchDeleteClusterNodesCommand_base: {
    new (input: BatchDeleteClusterNodesCommandInput): import("@smithy/core/client").CommandImpl<BatchDeleteClusterNodesCommandInput, BatchDeleteClusterNodesCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BatchDeleteClusterNodesCommandInput): import("@smithy/core/client").CommandImpl<BatchDeleteClusterNodesCommandInput, BatchDeleteClusterNodesCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
