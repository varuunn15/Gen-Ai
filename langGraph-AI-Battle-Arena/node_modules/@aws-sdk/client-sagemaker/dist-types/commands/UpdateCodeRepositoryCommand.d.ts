...
declare const UpdateCodeRepositoryCommand_base: {
    new (input: UpdateCodeRepositoryCommandInput): import("@smithy/core/client").CommandImpl<UpdateCodeRepositoryCommandInput, UpdateCodeRepositoryCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateCodeRepositoryCommandInput): import("@smithy/core/client").CommandImpl<UpdateCodeRepositoryCommandInput, UpdateCodeRepositoryCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
