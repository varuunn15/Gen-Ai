...
declare const ListFlowDefinitionsCommand_base: {
    new (input: ListFlowDefinitionsCommandInput): import("@smithy/core/client").CommandImpl<ListFlowDefinitionsCommandInput, ListFlowDefinitionsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListFlowDefinitionsCommandInput]): import("@smithy/core/client").CommandImpl<ListFlowDefinitionsCommandInput, ListFlowDefinitionsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
