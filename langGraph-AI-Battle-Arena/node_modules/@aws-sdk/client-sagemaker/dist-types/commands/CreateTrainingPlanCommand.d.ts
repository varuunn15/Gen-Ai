...
declare const CreateTrainingPlanCommand_base: {
    new (input: CreateTrainingPlanCommandInput): import("@smithy/core/client").CommandImpl<CreateTrainingPlanCommandInput, CreateTrainingPlanCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateTrainingPlanCommandInput): import("@smithy/core/client").CommandImpl<CreateTrainingPlanCommandInput, CreateTrainingPlanCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
