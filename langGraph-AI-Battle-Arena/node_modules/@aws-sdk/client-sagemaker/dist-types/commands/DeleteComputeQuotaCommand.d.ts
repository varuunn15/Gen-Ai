...
declare const DeleteComputeQuotaCommand_base: {
    new (input: DeleteComputeQuotaCommandInput): import("@smithy/core/client").CommandImpl<DeleteComputeQuotaCommandInput, DeleteComputeQuotaCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteComputeQuotaCommandInput): import("@smithy/core/client").CommandImpl<DeleteComputeQuotaCommandInput, DeleteComputeQuotaCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
