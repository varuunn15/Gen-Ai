...
declare const CreateMlflowTrackingServerCommand_base: {
    new (input: CreateMlflowTrackingServerCommandInput): import("@smithy/core/client").CommandImpl<CreateMlflowTrackingServerCommandInput, CreateMlflowTrackingServerCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateMlflowTrackingServerCommandInput): import("@smithy/core/client").CommandImpl<CreateMlflowTrackingServerCommandInput, CreateMlflowTrackingServerCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
