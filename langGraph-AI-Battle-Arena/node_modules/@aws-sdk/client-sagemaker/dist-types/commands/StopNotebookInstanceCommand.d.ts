...
declare const StopNotebookInstanceCommand_base: {
    new (input: StopNotebookInstanceCommandInput): import("@smithy/core/client").CommandImpl<StopNotebookInstanceCommandInput, StopNotebookInstanceCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopNotebookInstanceCommandInput): import("@smithy/core/client").CommandImpl<StopNotebookInstanceCommandInput, StopNotebookInstanceCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
