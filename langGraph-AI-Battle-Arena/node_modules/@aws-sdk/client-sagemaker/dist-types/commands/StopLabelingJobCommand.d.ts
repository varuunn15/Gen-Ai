...
declare const StopLabelingJobCommand_base: {
    new (input: StopLabelingJobCommandInput): import("@smithy/core/client").CommandImpl<StopLabelingJobCommandInput, StopLabelingJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopLabelingJobCommandInput): import("@smithy/core/client").CommandImpl<StopLabelingJobCommandInput, StopLabelingJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
