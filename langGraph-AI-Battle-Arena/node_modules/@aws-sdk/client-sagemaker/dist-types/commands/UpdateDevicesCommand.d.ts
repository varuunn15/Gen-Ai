...
declare const UpdateDevicesCommand_base: {
    new (input: UpdateDevicesCommandInput): import("@smithy/core/client").CommandImpl<UpdateDevicesCommandInput, UpdateDevicesCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateDevicesCommandInput): import("@smithy/core/client").CommandImpl<UpdateDevicesCommandInput, UpdateDevicesCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
