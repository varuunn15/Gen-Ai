...
declare const StopTrainingJobCommand_base: {
    new (input: StopTrainingJobCommandInput): import("@smithy/core/client").CommandImpl<StopTrainingJobCommandInput, StopTrainingJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopTrainingJobCommandInput): import("@smithy/core/client").CommandImpl<StopTrainingJobCommandInput, StopTrainingJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
