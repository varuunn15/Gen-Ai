...
declare const CreateModelCardCommand_base: {
    new (input: CreateModelCardCommandInput): import("@smithy/core/client").CommandImpl<CreateModelCardCommandInput, CreateModelCardCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateModelCardCommandInput): import("@smithy/core/client").CommandImpl<CreateModelCardCommandInput, CreateModelCardCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
