...
declare const DescribeSubscribedWorkteamCommand_base: {
    new (input: DescribeSubscribedWorkteamCommandInput): import("@smithy/core/client").CommandImpl<DescribeSubscribedWorkteamCommandInput, DescribeSubscribedWorkteamCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeSubscribedWorkteamCommandInput): import("@smithy/core/client").CommandImpl<DescribeSubscribedWorkteamCommandInput, DescribeSubscribedWorkteamCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
