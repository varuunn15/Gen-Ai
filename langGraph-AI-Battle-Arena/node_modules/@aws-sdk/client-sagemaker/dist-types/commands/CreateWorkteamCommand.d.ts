...
declare const CreateWorkteamCommand_base: {
    new (input: CreateWorkteamCommandInput): import("@smithy/core/client").CommandImpl<CreateWorkteamCommandInput, CreateWorkteamCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateWorkteamCommandInput): import("@smithy/core/client").CommandImpl<CreateWorkteamCommandInput, CreateWorkteamCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
