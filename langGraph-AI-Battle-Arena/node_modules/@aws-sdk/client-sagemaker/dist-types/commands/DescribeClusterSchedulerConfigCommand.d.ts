...
declare const DescribeClusterSchedulerConfigCommand_base: {
    new (input: DescribeClusterSchedulerConfigCommandInput): import("@smithy/core/client").CommandImpl<DescribeClusterSchedulerConfigCommandInput, DescribeClusterSchedulerConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeClusterSchedulerConfigCommandInput): import("@smithy/core/client").CommandImpl<DescribeClusterSchedulerConfigCommandInput, DescribeClusterSchedulerConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
