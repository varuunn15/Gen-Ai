...
declare const CreatePresignedDomainUrlCommand_base: {
    new (input: CreatePresignedDomainUrlCommandInput): import("@smithy/core/client").CommandImpl<CreatePresignedDomainUrlCommandInput, CreatePresignedDomainUrlCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreatePresignedDomainUrlCommandInput): import("@smithy/core/client").CommandImpl<CreatePresignedDomainUrlCommandInput, CreatePresignedDomainUrlCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
