...
declare const CreateAutoMLJobV2Command_base: {
    new (input: CreateAutoMLJobV2CommandInput): import("@smithy/core/client").CommandImpl<CreateAutoMLJobV2CommandInput, CreateAutoMLJobV2CommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateAutoMLJobV2CommandInput): import("@smithy/core/client").CommandImpl<CreateAutoMLJobV2CommandInput, CreateAutoMLJobV2CommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
