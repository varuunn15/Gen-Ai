...
declare const ListInferenceComponentsCommand_base: {
    new (input: ListInferenceComponentsCommandInput): import("@smithy/core/client").CommandImpl<ListInferenceComponentsCommandInput, ListInferenceComponentsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListInferenceComponentsCommandInput]): import("@smithy/core/client").CommandImpl<ListInferenceComponentsCommandInput, ListInferenceComponentsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
