...
declare const CreateLabelingJobCommand_base: {
    new (input: CreateLabelingJobCommandInput): import("@smithy/core/client").CommandImpl<CreateLabelingJobCommandInput, CreateLabelingJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateLabelingJobCommandInput): import("@smithy/core/client").CommandImpl<CreateLabelingJobCommandInput, CreateLabelingJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
