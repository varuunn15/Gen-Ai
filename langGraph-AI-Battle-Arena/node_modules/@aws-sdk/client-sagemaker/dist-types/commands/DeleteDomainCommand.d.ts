...
declare const DeleteDomainCommand_base: {
    new (input: DeleteDomainCommandInput): import("@smithy/core/client").CommandImpl<DeleteDomainCommandInput, DeleteDomainCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteDomainCommandInput): import("@smithy/core/client").CommandImpl<DeleteDomainCommandInput, DeleteDomainCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
