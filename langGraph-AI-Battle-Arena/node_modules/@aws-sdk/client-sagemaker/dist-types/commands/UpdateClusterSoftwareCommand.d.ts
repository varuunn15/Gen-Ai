...
declare const UpdateClusterSoftwareCommand_base: {
    new (input: UpdateClusterSoftwareCommandInput): import("@smithy/core/client").CommandImpl<UpdateClusterSoftwareCommandInput, UpdateClusterSoftwareCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateClusterSoftwareCommandInput): import("@smithy/core/client").CommandImpl<UpdateClusterSoftwareCommandInput, UpdateClusterSoftwareCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
