...
declare const UpdateHubContentCommand_base: {
    new (input: UpdateHubContentCommandInput): import("@smithy/core/client").CommandImpl<UpdateHubContentCommandInput, UpdateHubContentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateHubContentCommandInput): import("@smithy/core/client").CommandImpl<UpdateHubContentCommandInput, UpdateHubContentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
