...
declare const ListClusterEventsCommand_base: {
    new (input: ListClusterEventsCommandInput): import("@smithy/core/client").CommandImpl<ListClusterEventsCommandInput, ListClusterEventsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListClusterEventsCommandInput): import("@smithy/core/client").CommandImpl<ListClusterEventsCommandInput, ListClusterEventsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
