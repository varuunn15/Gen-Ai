...
declare const ListArtifactsCommand_base: {
    new (input: ListArtifactsCommandInput): import("@smithy/core/client").CommandImpl<ListArtifactsCommandInput, ListArtifactsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListArtifactsCommandInput]): import("@smithy/core/client").CommandImpl<ListArtifactsCommandInput, ListArtifactsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
