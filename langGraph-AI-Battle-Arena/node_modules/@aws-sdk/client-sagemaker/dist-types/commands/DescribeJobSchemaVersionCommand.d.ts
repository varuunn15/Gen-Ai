...
declare const DescribeJobSchemaVersionCommand_base: {
    new (input: DescribeJobSchemaVersionCommandInput): import("@smithy/core/client").CommandImpl<DescribeJobSchemaVersionCommandInput, DescribeJobSchemaVersionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeJobSchemaVersionCommandInput): import("@smithy/core/client").CommandImpl<DescribeJobSchemaVersionCommandInput, DescribeJobSchemaVersionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
