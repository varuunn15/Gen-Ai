...
declare const StartInferenceExperimentCommand_base: {
    new (input: StartInferenceExperimentCommandInput): import("@smithy/core/client").CommandImpl<StartInferenceExperimentCommandInput, StartInferenceExperimentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartInferenceExperimentCommandInput): import("@smithy/core/client").CommandImpl<StartInferenceExperimentCommandInput, StartInferenceExperimentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
