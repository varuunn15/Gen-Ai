...
declare const DeleteWorkforceCommand_base: {
    new (input: DeleteWorkforceCommandInput): import("@smithy/core/client").CommandImpl<DeleteWorkforceCommandInput, DeleteWorkforceCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteWorkforceCommandInput): import("@smithy/core/client").CommandImpl<DeleteWorkforceCommandInput, DeleteWorkforceCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
