...
declare const StopCompilationJobCommand_base: {
    new (input: StopCompilationJobCommandInput): import("@smithy/core/client").CommandImpl<StopCompilationJobCommandInput, StopCompilationJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopCompilationJobCommandInput): import("@smithy/core/client").CommandImpl<StopCompilationJobCommandInput, StopCompilationJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
