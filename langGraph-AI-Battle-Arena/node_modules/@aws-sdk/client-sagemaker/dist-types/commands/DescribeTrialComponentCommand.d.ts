...
declare const DescribeTrialComponentCommand_base: {
    new (input: DescribeTrialComponentCommandInput): import("@smithy/core/client").CommandImpl<DescribeTrialComponentCommandInput, DescribeTrialComponentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeTrialComponentCommandInput): import("@smithy/core/client").CommandImpl<DescribeTrialComponentCommandInput, DescribeTrialComponentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
