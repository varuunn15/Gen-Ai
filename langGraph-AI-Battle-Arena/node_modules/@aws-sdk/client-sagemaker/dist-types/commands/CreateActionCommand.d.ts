...
declare const CreateActionCommand_base: {
    new (input: CreateActionCommandInput): import("@smithy/core/client").CommandImpl<CreateActionCommandInput, CreateActionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateActionCommandInput): import("@smithy/core/client").CommandImpl<CreateActionCommandInput, CreateActionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
