...
declare const ListFeatureGroupsCommand_base: {
    new (input: ListFeatureGroupsCommandInput): import("@smithy/core/client").CommandImpl<ListFeatureGroupsCommandInput, ListFeatureGroupsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListFeatureGroupsCommandInput]): import("@smithy/core/client").CommandImpl<ListFeatureGroupsCommandInput, ListFeatureGroupsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
