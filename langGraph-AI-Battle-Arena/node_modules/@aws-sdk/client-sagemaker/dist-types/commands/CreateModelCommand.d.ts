...
declare const CreateModelCommand_base: {
    new (input: CreateModelCommandInput): import("@smithy/core/client").CommandImpl<CreateModelCommandInput, CreateModelCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateModelCommandInput): import("@smithy/core/client").CommandImpl<CreateModelCommandInput, CreateModelCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
