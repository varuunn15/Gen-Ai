...
declare const UpdatePipelineVersionCommand_base: {
    new (input: UpdatePipelineVersionCommandInput): import("@smithy/core/client").CommandImpl<UpdatePipelineVersionCommandInput, UpdatePipelineVersionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdatePipelineVersionCommandInput): import("@smithy/core/client").CommandImpl<UpdatePipelineVersionCommandInput, UpdatePipelineVersionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
