...
declare const ListExperimentsCommand_base: {
    new (input: ListExperimentsCommandInput): import("@smithy/core/client").CommandImpl<ListExperimentsCommandInput, ListExperimentsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListExperimentsCommandInput]): import("@smithy/core/client").CommandImpl<ListExperimentsCommandInput, ListExperimentsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
