...
declare const StopOptimizationJobCommand_base: {
    new (input: StopOptimizationJobCommandInput): import("@smithy/core/client").CommandImpl<StopOptimizationJobCommandInput, StopOptimizationJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopOptimizationJobCommandInput): import("@smithy/core/client").CommandImpl<StopOptimizationJobCommandInput, StopOptimizationJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
