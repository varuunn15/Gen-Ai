...
declare const ListAIRecommendationJobsCommand_base: {
    new (input: ListAIRecommendationJobsCommandInput): import("@smithy/core/client").CommandImpl<ListAIRecommendationJobsCommandInput, ListAIRecommendationJobsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListAIRecommendationJobsCommandInput]): import("@smithy/core/client").CommandImpl<ListAIRecommendationJobsCommandInput, ListAIRecommendationJobsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
