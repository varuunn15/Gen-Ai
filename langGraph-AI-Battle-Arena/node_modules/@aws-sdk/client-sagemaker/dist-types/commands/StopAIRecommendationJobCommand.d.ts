...
declare const StopAIRecommendationJobCommand_base: {
    new (input: StopAIRecommendationJobCommandInput): import("@smithy/core/client").CommandImpl<StopAIRecommendationJobCommandInput, StopAIRecommendationJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopAIRecommendationJobCommandInput): import("@smithy/core/client").CommandImpl<StopAIRecommendationJobCommandInput, StopAIRecommendationJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
