...
declare const UpdatePipelineExecutionCommand_base: {
    new (input: UpdatePipelineExecutionCommandInput): import("@smithy/core/client").CommandImpl<UpdatePipelineExecutionCommandInput, UpdatePipelineExecutionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdatePipelineExecutionCommandInput): import("@smithy/core/client").CommandImpl<UpdatePipelineExecutionCommandInput, UpdatePipelineExecutionCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
