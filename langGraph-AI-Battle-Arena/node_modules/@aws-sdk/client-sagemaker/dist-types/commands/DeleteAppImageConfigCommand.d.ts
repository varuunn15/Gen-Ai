...
declare const DeleteAppImageConfigCommand_base: {
    new (input: DeleteAppImageConfigCommandInput): import("@smithy/core/client").CommandImpl<DeleteAppImageConfigCommandInput, DeleteAppImageConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteAppImageConfigCommandInput): import("@smithy/core/client").CommandImpl<DeleteAppImageConfigCommandInput, DeleteAppImageConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
