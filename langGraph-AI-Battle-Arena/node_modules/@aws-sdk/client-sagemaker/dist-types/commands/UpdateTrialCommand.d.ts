...
declare const UpdateTrialCommand_base: {
    new (input: UpdateTrialCommandInput): import("@smithy/core/client").CommandImpl<UpdateTrialCommandInput, UpdateTrialCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateTrialCommandInput): import("@smithy/core/client").CommandImpl<UpdateTrialCommandInput, UpdateTrialCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
