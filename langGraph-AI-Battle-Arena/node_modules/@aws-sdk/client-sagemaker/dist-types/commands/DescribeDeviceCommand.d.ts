...
declare const DescribeDeviceCommand_base: {
    new (input: DescribeDeviceCommandInput): import("@smithy/core/client").CommandImpl<DescribeDeviceCommandInput, DescribeDeviceCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeDeviceCommandInput): import("@smithy/core/client").CommandImpl<DescribeDeviceCommandInput, DescribeDeviceCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
