...
declare const GetDeviceFleetReportCommand_base: {
    new (input: GetDeviceFleetReportCommandInput): import("@smithy/core/client").CommandImpl<GetDeviceFleetReportCommandInput, GetDeviceFleetReportCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetDeviceFleetReportCommandInput): import("@smithy/core/client").CommandImpl<GetDeviceFleetReportCommandInput, GetDeviceFleetReportCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
