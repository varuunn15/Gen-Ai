...
declare const UpdateArtifactCommand_base: {
    new (input: UpdateArtifactCommandInput): import("@smithy/core/client").CommandImpl<UpdateArtifactCommandInput, UpdateArtifactCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateArtifactCommandInput): import("@smithy/core/client").CommandImpl<UpdateArtifactCommandInput, UpdateArtifactCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
