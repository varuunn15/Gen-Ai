...
declare const CreateCompilationJobCommand_base: {
    new (input: CreateCompilationJobCommandInput): import("@smithy/core/client").CommandImpl<CreateCompilationJobCommandInput, CreateCompilationJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateCompilationJobCommandInput): import("@smithy/core/client").CommandImpl<CreateCompilationJobCommandInput, CreateCompilationJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
