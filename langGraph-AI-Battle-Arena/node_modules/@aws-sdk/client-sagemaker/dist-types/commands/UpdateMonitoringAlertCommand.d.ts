...
declare const UpdateMonitoringAlertCommand_base: {
    new (input: UpdateMonitoringAlertCommandInput): import("@smithy/core/client").CommandImpl<UpdateMonitoringAlertCommandInput, UpdateMonitoringAlertCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateMonitoringAlertCommandInput): import("@smithy/core/client").CommandImpl<UpdateMonitoringAlertCommandInput, UpdateMonitoringAlertCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
