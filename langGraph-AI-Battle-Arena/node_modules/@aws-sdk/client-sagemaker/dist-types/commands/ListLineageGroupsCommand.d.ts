...
declare const ListLineageGroupsCommand_base: {
    new (input: ListLineageGroupsCommandInput): import("@smithy/core/client").CommandImpl<ListLineageGroupsCommandInput, ListLineageGroupsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListLineageGroupsCommandInput]): import("@smithy/core/client").CommandImpl<ListLineageGroupsCommandInput, ListLineageGroupsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
