...
declare const DescribeArtifactCommand_base: {
    new (input: DescribeArtifactCommandInput): import("@smithy/core/client").CommandImpl<DescribeArtifactCommandInput, DescribeArtifactCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeArtifactCommandInput): import("@smithy/core/client").CommandImpl<DescribeArtifactCommandInput, DescribeArtifactCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
