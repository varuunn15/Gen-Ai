...
declare const AssociateTrialComponentCommand_base: {
    new (input: AssociateTrialComponentCommandInput): import("@smithy/core/client").CommandImpl<AssociateTrialComponentCommandInput, AssociateTrialComponentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateTrialComponentCommandInput): import("@smithy/core/client").CommandImpl<AssociateTrialComponentCommandInput, AssociateTrialComponentCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
