...
declare const DescribeAIBenchmarkJobCommand_base: {
    new (input: DescribeAIBenchmarkJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeAIBenchmarkJobCommandInput, DescribeAIBenchmarkJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeAIBenchmarkJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeAIBenchmarkJobCommandInput, DescribeAIBenchmarkJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
