...
declare const DeleteContextCommand_base: {
    new (input: DeleteContextCommandInput): import("@smithy/core/client").CommandImpl<DeleteContextCommandInput, DeleteContextCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteContextCommandInput): import("@smithy/core/client").CommandImpl<DeleteContextCommandInput, DeleteContextCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
