...
declare const DescribeAppImageConfigCommand_base: {
    new (input: DescribeAppImageConfigCommandInput): import("@smithy/core/client").CommandImpl<DescribeAppImageConfigCommandInput, DescribeAppImageConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeAppImageConfigCommandInput): import("@smithy/core/client").CommandImpl<DescribeAppImageConfigCommandInput, DescribeAppImageConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
