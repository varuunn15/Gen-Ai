...
declare const UpdateFeatureMetadataCommand_base: {
    new (input: UpdateFeatureMetadataCommandInput): import("@smithy/core/client").CommandImpl<UpdateFeatureMetadataCommandInput, UpdateFeatureMetadataCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateFeatureMetadataCommandInput): import("@smithy/core/client").CommandImpl<UpdateFeatureMetadataCommandInput, UpdateFeatureMetadataCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
