...
declare const DeleteHumanTaskUiCommand_base: {
    new (input: DeleteHumanTaskUiCommandInput): import("@smithy/core/client").CommandImpl<DeleteHumanTaskUiCommandInput, DeleteHumanTaskUiCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteHumanTaskUiCommandInput): import("@smithy/core/client").CommandImpl<DeleteHumanTaskUiCommandInput, DeleteHumanTaskUiCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
