...
declare const ListMlflowAppsCommand_base: {
    new (input: ListMlflowAppsCommandInput): import("@smithy/core/client").CommandImpl<ListMlflowAppsCommandInput, ListMlflowAppsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListMlflowAppsCommandInput]): import("@smithy/core/client").CommandImpl<ListMlflowAppsCommandInput, ListMlflowAppsCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
