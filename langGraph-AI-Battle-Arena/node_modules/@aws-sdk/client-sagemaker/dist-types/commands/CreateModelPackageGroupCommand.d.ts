...
declare const CreateModelPackageGroupCommand_base: {
    new (input: CreateModelPackageGroupCommandInput): import("@smithy/core/client").CommandImpl<CreateModelPackageGroupCommandInput, CreateModelPackageGroupCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateModelPackageGroupCommandInput): import("@smithy/core/client").CommandImpl<CreateModelPackageGroupCommandInput, CreateModelPackageGroupCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
