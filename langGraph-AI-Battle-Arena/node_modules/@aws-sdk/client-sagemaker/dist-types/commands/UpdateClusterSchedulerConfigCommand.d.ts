...
declare const UpdateClusterSchedulerConfigCommand_base: {
    new (input: UpdateClusterSchedulerConfigCommandInput): import("@smithy/core/client").CommandImpl<UpdateClusterSchedulerConfigCommandInput, UpdateClusterSchedulerConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateClusterSchedulerConfigCommandInput): import("@smithy/core/client").CommandImpl<UpdateClusterSchedulerConfigCommandInput, UpdateClusterSchedulerConfigCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
