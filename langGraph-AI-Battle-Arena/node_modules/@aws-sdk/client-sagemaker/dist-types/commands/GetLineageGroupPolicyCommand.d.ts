...
declare const GetLineageGroupPolicyCommand_base: {
    new (input: GetLineageGroupPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetLineageGroupPolicyCommandInput, GetLineageGroupPolicyCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetLineageGroupPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetLineageGroupPolicyCommandInput, GetLineageGroupPolicyCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
