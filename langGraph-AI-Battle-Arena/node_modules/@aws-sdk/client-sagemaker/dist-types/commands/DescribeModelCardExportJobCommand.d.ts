...
declare const DescribeModelCardExportJobCommand_base: {
    new (input: DescribeModelCardExportJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeModelCardExportJobCommandInput, DescribeModelCardExportJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeModelCardExportJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeModelCardExportJobCommandInput, DescribeModelCardExportJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
