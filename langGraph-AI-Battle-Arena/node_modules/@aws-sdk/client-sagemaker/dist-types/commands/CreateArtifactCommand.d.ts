...
declare const CreateArtifactCommand_base: {
    new (input: CreateArtifactCommandInput): import("@smithy/core/client").CommandImpl<CreateArtifactCommandInput, CreateArtifactCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateArtifactCommandInput): import("@smithy/core/client").CommandImpl<CreateArtifactCommandInput, CreateArtifactCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
